import { ContactPageContent, SolutionsPageContent } from '@/types';

export const defaultSolutionsVi: SolutionsPageContent = {
  hero: {
...
export const defaultSolutionsEn: SolutionsPageContent = {
  hero: {
  ...
  tracks: [
    {
      ...
      title: 'Pair rooftop solar with homeowner reporting and battery-ready operations.',
      body:
  ...
  packagesSection: {
    ...
    title: 'The pricing cards below can be reused directly in your solution selling flow.',
  },
  nextStepCta: {
    eyebrow: 'Next step',
    title:
...
export const defaultContactVi: ContactPageContent = {
  hero: {
    eyebrow: 'Liên hệ',
    title:
...
export const defaultContactEn: ContactPageContent = {
  hero: {
    eyebrow: 'Contact',
    title:
